...
from src.models.modules.vqvae_model import vqvae_model_2d
#from modules.vqvae_model import vqvae_model_2d
from src.models.losses import L2_vqvae
#from losses import L2_vqvae
import torch
...
class vqvae_2d_trainer(LightningModule):
    def __init__(self,cfg):
        super().__init__()
        self.cfg = cfg
        self.vqvae_2d = vqvae_model_2d(cfg)
        self.criterion = L2_vqvae()
    ...
    def training_step(self, batch, batch_idx: int):
        ...
        loss_recon = loss['recon_error']
        loss_combined= loss['combined_loss']
        loss = loss_combined


        self.log('train/Loss_vq', vq_loss, prog_bar=True, on_step=False, on_epoch=True)
        self.log('train/Loss_Recon', loss_recon, prog_bar=True, on_step=False, on_epoch=True)
    ...
    def validation_step(self, batch: Any, batch_idx: int):
        ...
        # log val metrics
        self.log('val/Loss_vq', vq_loss, prog_bar=True, on_step=False, on_epoch=True)
        self.log('val/Loss_Recon', loss_recon, prog_bar=True, on_step=False, on_epoch=True)
    ...
    def test_step(self, batch: Any, batch_idx: int):
        ...
        for i in range(input.size(1)):
            ...
            AnomalyScorevq.append(loss['vq_loss'].item())
        ...
        if self.cfg.evalSeg:
            ...
            # Pixel-Wise Segmentation Error Metrics based on Differenceimage(recon_image) - changeL
            ...
            # Calculate Dice Score with thresholded volum
